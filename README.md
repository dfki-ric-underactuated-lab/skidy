...
For installing the required test dependencies use:

```bash
python3 -m pip install skidy[testing_required]
```

For installing all test dependencies inclusive optional dependencies (virtual environment recommended) use:
